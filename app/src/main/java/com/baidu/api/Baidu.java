...
public class Baidu implements Parcelable {
    ...
    private com.baidu.api.AccessTokenManager accessTokenManager;
    ...
    public Baidu(Parcel in) {
        ...
        this.accessTokenManager = com.baidu.api.AccessTokenManager.CREATOR.createFromParcel(in);
    }
    ...
    public void init(Context context) {
        ...
        this.accessTokenManager = new com.baidu.api.AccessTokenManager(context);
     ...
     */
    public void authorize(Activity activity,boolean isForceLogin,boolean isConfirmLogin, final BaiduDialogListener listener) {
     ...
     */
    public void authorize(Activity activity, String[] permissions,boolean isForceLogin,boolean isConfirmLogin,
        ...
        this.authorize(activity, permissions, isForceLogin,isConfirmLogin,new BaiduDialogListener() {
     ...
     */
    private void authorize(Activity activity, String[] permissions,boolean isForceLogin,boolean isConfirmLogin,
