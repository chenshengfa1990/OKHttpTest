...
public class Util {
    ...
    private static HttpURLConnection getURLConnection(String url, String method, String ctype)
        ...
        if ("https".equalsIgnoreCase(urlObj.getProtocol())) {
            ...
            HttpsURLConnection connHttps = (HttpsURLConnection) urlObj.openConnection();
    ...
    public static void checkResponse(String response) throws com.baidu.api.BaiduException {
        if (isEmpty(response)) {
            return;
        }
        JSONObject json;
        try {
            ...
            if (json.has("error") && json.has("error_description")) {
                ...
                throw new com.baidu.api.BaiduException(errorCode, errorDesp);
            }
