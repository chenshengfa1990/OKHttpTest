        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            switch (msg.what) {
                case DOWNPICTURE:
                    ...
                    urlBuilder.addQueryParameter("access_token", baiduAccessToken);
                ...
                case PRECREATE:
                    ...
                    urlBuilder1.addQueryParameter("access_token", baiduAccessToken)
...
//                String url = "https://api.huobi.de.com/market/history/kline?period=1day&size=200&symbol=btcusdt";
        ...
        downButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //String url = "https://pan.baidu.com/rest/2.0/xpan/file?method=imagelist";
        ...
        uploadButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                OkHttpClient client = new OkHttpClient();
                String filePath = MainActivity.this.getExternalFilesDir(null).getAbsolutePath();
    ...
    private void getBaiduAccessToken() {
        ...
        baidu.authorize(MainActivity.this, false,true, new BaiduDialog.BaiduDialogListener() {
            @Override
            public void onComplete(Bundle bundle) {
                baidu.init(MainActivity.this);
                AccessTokenManager atm = baidu.getAccessTokenManager();
                String accessToken = atm.getAccessToken();
                Log.d("csf", accessToken);
    ...
    private void writeFile(Response response) {
        ...
        File[] sdPath = this.getExternalFilesDirs(Environment.MEDIA_MOUNTED);
...
//            if(file.exists()) {
//                Log.d("csf", "file already exist");
//                file.delete();
//            }
//            if(file.exists()) {
//                Log.d("csf", "file exist");
//            } else {
//                if(!file.createNewFile()) {
//                    Log.d("csf", "file create fail");
//                } else {
//                    Log.d("csf", "file create success");
//                }
//
//            }
